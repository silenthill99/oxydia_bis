        ...
        <header className={"bg-blue-500 text-white"}>
            <div className={"container mx-auto flex justify-between items-center flex-wrap px-5 md:p-0"}>
                ...
                <nav className={"grid grid-cols-3 md:flex gap-2 items-center flex-wrap"}>
                    ...
                    <div className={`group p-2 relative text-center flex justify-center ${(url === "/rules-pvp" || url === "/rules-rp") && "border-x"}`}>
                        ...
                        <ul className={"absolute bg-blue-400 hidden group-hover:block shadow z-10 top-10"}>
                            <li className={"w-52"}><Link href={route('rules-pvp')} className={isActive("/rules-pvp")}>Règlement Pvp-Faction</Link></li>
                            <li className={"w-52"}><Link href={route('rules-rp')} className={isActive("/rules-rp")}>Règlement RP</Link></li>
                            <li className={"w-52"}><Link href="" className={"hover:bg-blue-500 inline-block w-full"}>Règlement Harry PoCraft</Link></li>
                        </ul>
                    </div>
