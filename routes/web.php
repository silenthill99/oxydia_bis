...
Route::get('/mentions-legales', MentionsLegalesController::class)->name('mentions-legales');

Route::inertia('/join-infos', 'join-infos')->name('join.infos');

Route::get('/test', function () {
    return new RecruitMailValid(Auth::user());
